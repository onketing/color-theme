...
import HomepagePreview from "./components/HomepagePreview.jsx";
    ...
    <div className="min-h-screen">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <div className="text-[15px] font-extrabold tracking-tight text-neutral-900">
                온케팅 <span className="font-medium text-neutral-400">| 컬러 테마</span>
              </div>
            </div>
          </div>
          <a
            href="https://lawus.co.kr/"
            target="_blank"
            rel="noreferrer"
      ...
      <section className="mx-auto max-w-6xl px-5 pb-8 pt-12 sm:pt-16">
        ...
        <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-neutral-600 sm:text-base">
          요청하신 <strong className="font-semibold text-neutral-900">로어스(lawus.co.kr)</strong>{" "}
          홈페이지의 색감을 실제 디자인에서 추출했습니다. 원본 시그니처 테마와 함께, 같은{" "}
          <strong className="font-semibold text-neutral-900">따뜻한 어스 톤 · 신뢰감 계열</strong>의
          변형 팔레트 5종을 더해 총 6가지로 제안드립니다. 아래에서 테마를 선택하면 실제 홈페이지
          화면에 적용된 모습을 미리 보실 수 있습니다.
        </p>
      </section>
      ...
      <footer className="border-t border-neutral-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-5 py-7 text-[12px] text-neutral-400 sm:flex-row">
          <span>© 2026 온케팅 (ONKETING) · 컬러 테마 제안 쇼케이스</span>
          <span>초이스 행정사 사무소 홈페이지 제작 프로젝트</span>
        </div>
      </footer>
    </div>
  );
