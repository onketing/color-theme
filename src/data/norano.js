...
const themes = [
  {
    ...
    description:
      "로터리 커팅 매트에서 뽑은 지금의 초록입니다. 재단하는 작업대는 어디서나 이 색이라, 재봉을 하는 사람은 0.5초에 알아봅니다. 장식이 아니라 이 학원이 매일 쓰는 물건의 색이라는 점이 다른 후보와 갈리는 지점입니다. 나머지 스물세 종은 전부 이 색을 기준으로 옮긴 것입니다.",
    mood: ["기준", "작업대", "선명함"],
    colors: {
      background: "#fcfdfd",
      surface: "#f5f6f7",
...

  {
    ...
    source: "노랑·초록 중간",
    fit: ["활기"],
    tagline: "가장 초록다운 초록 · 잔디",
    description:
      "노랑과 청록 사이 한가운데의 초록입니다. 설명이 필요 없는 '그냥 초록'이라 누구나 초록으로 인식하고, 라임보다 차분하면서 커팅 매트보다 밝습니다. 무난한 것이 장점이자 단점입니다.",
    mood: ["보편", "선명", "친숙"],
    colors: {
      background: "#fcfdfd",
      surface: "#f5f6f7",
